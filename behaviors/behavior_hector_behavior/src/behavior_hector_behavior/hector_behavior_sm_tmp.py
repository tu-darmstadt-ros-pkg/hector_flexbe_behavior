...
import roslib; roslib.load_manifest('behavior_hector_behavior')
...
class hectorbehaviorSM(Behavior):
	...
	def create(self):
		...
		_state_machine.userdata.goalId = 'predefined'
		...
		with _sm_exploration_6:
			...
			OperatableStateMachine.add('Wait',
										Wait_Exploration(),
										transitions={'restart': 'Wait', 'waiting': 'Wait'},
