	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('follow_waypoints',
										FollowWaypointsState(desired_speed=self.speed, position_tolerance=0.0, angle_tolerance=3, rotate_to_goal=0, reexplore_time=5, use_planning=self.use_planning),
