...
class FollowWaypointsState(EventState):
	'''
	...
	def __init__(self, desired_speed=0, position_tolerance=0, angle_tolerance=0, rotate_to_goal=0, reexplore_time=5, reverse_allowed=True, reverse_forced=False, use_planning=True):
		...
		Constructor
		'''
		super(FollowWaypointsState, self).__init__(outcomes=['reached', 'failed', 'reverse', 'stuck'],
											input_keys=['waypoints', 'waypoints2'], output_keys=['waypoints', 'waypoints2'])
